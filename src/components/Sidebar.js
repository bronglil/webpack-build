    ...
    <aside>
        ...
        <div className="sidebar-section">
            ...
            <ul className="contact-list">
                <li><FaEnvelope /> <a href="mailto:sajid@example.com">sajid@example.com</a></li>
                <li><FaPhone /> <a href="tel:+1234567890">+123 456 7890</a></li>
                <li><FaMapMarkerAlt /> Saint-Etienne, France</li>
            </ul>
        </div>
        ...
        <div className="sidebar-section">
            ...
            <ul className="social-links">
                ...
                <li><a href="https://www.github.com"><FaGithub /> GitHub</a></li>
